...
describe "Bowling game" do
	...
	describe "roll" do
		...
		it "we cannot get over 10 pins at final round" do
			9.times do
				mygame.roll(10)
			end
			expect(mygame.roll(11)).to eq(false)
		...
		it "we cannot get over 10 pins at final round #2" do
			10.times do
				mygame.roll(10)
			end
			expect(mygame.roll(11)).to eq(false)
		...
		it "we cannot get over 10 pins at final round #3" do
			11.times do
				mygame.roll(10)
			end
			expect(mygame.roll(11)).to eq(false)
		...
		it "we cannot 3 throws at final round when we have not get 1 more strikes" do
			9.times do
				mygame.roll(10)
			end
			mygame.roll(4)
